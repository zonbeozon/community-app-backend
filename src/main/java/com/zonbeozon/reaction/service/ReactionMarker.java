...
public class ReactionMarker {
    ...
    public void mark(Long contentId, ReactionContentType contentType, ReactionType reactionType) {
        reactionMarkHandlers.stream()
                ...
                .mark(contentId, reactionType);
    }

    public void unmark(Long contentId, ReactionContentType contentType) {
