...
public class PostRecommendServiceTest extends AbstractChannelIntegrationTest {
    ...
    void recommendShouldReturnPostsOrderedByTotalScoreDesc() {
        ...
        Post post_1 = testPostService.createAndSave(blogChannel, member, postMetric_1);
        Post post_2 = testPostService.createAndSave(blogChannel, member, postMetric_2);
        Post post_3 = testPostService.createAndSave(blogChannel, member, postMetric_3);
